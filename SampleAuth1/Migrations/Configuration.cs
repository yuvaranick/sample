namespace SampleAuth1.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SampleAuth1.Models.MyDbContext>
    {
        ...
        protected override void Seed(SampleAuth1.Models.MyDbContext context)
        {
